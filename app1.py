...
questions_prompt = ChatPromptTemplate.from_messages(
    ...
    The user wants questions of this difficulty level: {difficulty}
    - easy: newbie
    - hard: pro
...
formatting_prompt = ChatPromptTemplate.from_messages(
    ...
    Return the result as arguments for the `create_quiz` function.
...
def run_quiz_chain(_docs, topic, difficulty):
    ...
    response = chain.invoke({"docs": _docs, "difficulty": difficulty})
...
formatting_chain = formatting_prompt | llm_quiz
